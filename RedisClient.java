...
// XXX jedis.select(int index) to switch to `table`
  ...
  public Status read(String table, String key, Set<String> fields,
    ...
    try {
      String url = "https://europe-west1-serverless-functions-217415.cloudfunctions.net/function-2/read?table=user&key="+key;   
      URL obj;
  ...
  public Status insert(String table, String key,
    ...
    try {
      ...
      String url = "https://europe-west1-serverless-functions-217415.cloudfunctions.net/function-2/insert";
  ...
  public Status delete(String table, String key) {
    try {
      String url = "https://europe-west1-serverless-functions-217415.cloudfunctions.net/function-2/delete?table=user&key="+key;
      URL obj;
      HttpURLConnection con = null;
      obj = new URL(url);
      con = (HttpURLConnection) obj.openConnection();
  ...
  public Status update(String table, String key,
    ...
    try {
      Map<String, String> map = StringByteIterator.getStringMap(values);
      String url = "https://europe-west1-serverless-functions-217415.cloudfunctions.net/function-2/update?table=user&key="+key+"&";
      for (Map.Entry<String, String> field : map.entrySet()){
...
con.setRequestMethod("POST");
  ...
  public Status scan(String table, String startkey, int recordcount,
    ...
    try {
      String url = "https://europe-west1-serverless-functions-217415.cloudfunctions.net/function-2/scan?table=user&key="+startkey;
